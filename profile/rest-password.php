...
$stmt = $pdo->prepare("SELECT id, reset_expires FROM student WHERE reset_token = ?");
$stmt->execute([$token]);
$user = $stmt->fetch();
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($new_password !== $confirm_password) {
        ...
        $update_stmt = $pdo->prepare("UPDATE student SET password = ?, reset_token = NULL, reset_expires = NULL WHERE id = ?");
